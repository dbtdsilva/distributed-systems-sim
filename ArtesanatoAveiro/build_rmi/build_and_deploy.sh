...
cp --parents -r VectorClock/ dir_serverSide/shop/
...
cp --parents -r VectorClock/ dir_serverSide/warehouse/
...
cp --parents -r VectorClock/ dir_serverSide/workshop/
...
cp --parents -r VectorClock/ dir_clientSide/entrepreneur/
...
cp --parents -r VectorClock/ dir_clientSide/customer/
...
cp --parents -r VectorClock/ dir_clientSide/craftsman/